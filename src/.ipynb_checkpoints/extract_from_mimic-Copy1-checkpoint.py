...
def get_eligibility_query_prefix(pop_size_string, min_age_string, min_dur_string, max_dur_string, min_day_string):
    with open('/home/joe/Predict_PO2/new_mimic_cleaner/queries/eligibility.sql','r') as f:
        query_raw = f.read()
...
def get_static_covariates_query(eligibility_query_prefix):
    with open('/home/joe/Predict_PO2/new_mimic_cleaner/queries/static_covariates.sql','r') as f:
        query_raw = f.read()
    query_parsed = eligibility_query_prefix + query_raw # no formatting needed
    return query_parsed

def get_outcomes_query(eligibility_query_prefix):    
    with open('/home/joe/Predict_PO2/new_mimic_cleaner/queries/outcomes.sql','r') as f:
        query_raw = f.read()
...
def get_treatment_query(eligibility_query_prefix):
    with open('/home/joe/Predict_PO2/new_mimic_cleaner/queries/treatments.sql','r') as f:
        query_raw = f.read()
    query_parsed = eligibility_query_prefix + query_raw # no formatting needed yet
    return query_parsed
...
def get_inputs_query(eligibility_query_prefix):
    with open('/home/joe/Predict_PO2/new_mimic_cleaner/queries/inputs_dynamic.sql','r') as f:
        query_raw = f.read()
    query_parsed = eligibility_query_prefix + query_raw # no formatting needed yet
    return query_parsed

def get_dynamic_covariates_query(eligible_prefix, chartitems_to_keep, labitems_to_keep):
    with open('/home/joe/Predict_PO2/new_mimic_cleaner/queries/dynamic_covariates_choose_all.sql','r') as f:
        query_raw = f.read()
